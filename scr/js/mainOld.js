...
var vidgetsJson = $('textarea.json-widgetScrypt').text();
var vidgets = JSON.parse(vidgetsJson);
// console.log(vidgetsJson);
...
function load() {
    ...
    $('.clickAddCostum').on('click', function() {
        ...
        let idDiv = 'div-' + randomInteger(100, 99999);
        htmlContent.find('div.selected').append($('<div style="float: left; width: 100%;" class="widgetElement" id = "' + idDiv + '">' + html + '</div>'));
        iframeDocCont.html(htmlContent.html());
